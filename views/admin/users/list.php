                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($user['id'] != $_SESSION['user_id']): ?>
                                            ...
                                            <?php else: ?>                                            <a href="status.php?id=<?php echo $user['id']; ?>&action=activate" class="btn btn-sm btn-success" onclick="return confirm('Bạn có chắc chắn muốn kích hoạt người dùng này?')">
